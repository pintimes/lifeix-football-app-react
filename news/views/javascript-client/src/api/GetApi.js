(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.FootballWemediaApi.GetApi = factory(root.FootballWemediaApi.ApiClient, root.FootballWemediaApi.Comment, root.FootballWemediaApi.Post, root.FootballWemediaApi.User);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/GetApi~getCommentCallback
     ...
     * @param {module:api/GetApi~getCommentCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/GetApi~getCommentsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/GetApi~getCommentsCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/GetApi~getPostCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/GetApi~getPostCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/GetApi~getPostListCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Integer} opts.limit \u4E00\u9875\u663E\u793A\u6570\u76EE\uFF0C\u5982\u679C\u4E0D\u4F20\u9ED8\u8BA4&#x3D;10 (default to 10)
     * @param {Boolean} opts.isAsc \u662F\u5426\u662F\u5347\u5E8F\uFF0C\u9ED8\u8BA4\u662F\u5347\u5E8F (default to false)
     * @param {module:api/GetApi~getPostListCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/GetApi~likesPostsGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/Post>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Integer} opts.limit \u4E00\u9875\u663E\u793A\u6570\u76EE\uFF0C\u5982\u679C\u4E0D\u4F20\u9ED8\u8BA4&#x3D;10 (default to 10)
     * @param {module:api/GetApi~likesPostsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {Array.<module:model/Post>}
     */
     ...
     * @callback module:api/GetApi~likesUsersGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {Integer} opts.limit \u4E00\u9875\u663E\u793A\u6570\u76EE\uFF0C\u5982\u679C\u4E0D\u4F20\u9ED8\u8BA4&#x3D;10 (default to 10)
     * @param {module:api/GetApi~likesUsersGetCallback} callback The callback function, accepting three arguments: error, data, response
